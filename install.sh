...
"echo" "-e" "====================="
"echo" "-e" "Web Pulse Install Script"
"echo" "-e" "====================="
...
"echo" "-e" "---------------------------------------"
"echo" "-e" ""
"echo" "-e" "Local - Install Web Pulse on your current machine with git, Node.js and pm2"
"echo" "-e" "Docker - Install Web Pulse Docker container"
"echo" "-e" ""
if [ "$1" != "" ]; then
    type="$1"
else
