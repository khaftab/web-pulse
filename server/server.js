 ...
 */
console.log("Welcome to Web Pulse");
...
// Exit Web Pulse immediately if the Node.js version is banned
...
log.info("server", "Welcome to Web Pulse");
        ...
        socket.on("setup", async (username, password, callback) => {
            try {
                ...
                if ((await R.count("user")) !== 0) {
                    throw new Error("Web Pulse has been initialized. If you want to run setup again, please delete the database.");
                }
...
async function initDatabase(testMode = false) {
    ...
    // If there is no record in user table, it is a new Web Pulse instance, need to setup
    if ((await R.count("user")) === 0) {
