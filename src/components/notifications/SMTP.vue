<template>
    <div>
        <div class="mb-3">
            ...
            <input
                id="hostname"
                v-model="$parent.notification.smtpHost"
                type="text"
                class="form-control"
                required
            />
        ...
        <div class="mb-3">
            ...
            <select
                id="secure"
                v-model="$parent.notification.smtpSecure"
                class="form-select"
            >
        ...
        <div class="mb-3">
            ...
            <input
                ...
                required
                autocomplete="false"
                placeholder='"Web Pulse" &lt;example@kuma.pet&gt;'
            />
        ...
        <ToggleSection :heading="$t('smtpDkimSettings')">
            <i18n-t tag="div" keypath="smtpDkimDesc" class="form-text mb-3">
                <a href="https://nodemailer.com/dkim/" target="_blank">{{
                    $t("documentation")
                }}</a>
            </i18n-t>

            <div class="mb-3">
                <label for="dkim-domain" class="form-label">{{
                    $t("smtpDkimDomain")
                }}</label>
                <input
                    id="dkim-domain"
            ...
            <div class="mb-3">
                <label for="dkim-key-selector" class="form-label">{{
                    $t("smtpDkimKeySelector")
                }}</label>
                <input
            ...
            <div class="mb-3">
                <label for="dkim-private-key" class="form-label">{{
                    $t("smtpDkimPrivateKey")
                }}</label>
                <textarea
                    id="dkim-private-key"
            ...
            <div class="mb-3">
                <label for="dkim-hash-algo" class="form-label">{{
                    $t("smtpDkimHashAlgo")
                }}</label>
                <input
                    id="dkim-hash-algo"
            ...
            <div class="mb-3">
                <label for="dkim-header-fields" class="form-label">{{
                    $t("smtpDkimheaderFieldNames")
                }}</label>
                <input
            ...
            <div class="mb-3">
                <label for="dkim-skip-fields" class="form-label">{{
                    $t("smtpDkimskipFields")
                }}</label>
                <input
                    id="dkim-skip-fields"
        ...
        <div class="mb-3">
            <label for="subject-email" class="form-label">{{
