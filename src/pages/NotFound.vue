    ...
    <div>
        ...
        >
            ...
            >
                <object
                    ...
                    data="/icon.svg"
                />
                <span class="fs-4 title">Web Pulse</span>
            </router-link>
        </header>
        ...
        >
            ...
            >
                ...
                <span class="fs-4 title ms-2">Web Pulse</span>
            </router-link>
        </header>
        ...
        <div class="content">
            ...
            <div class="guide">
                ...
                <ul>
                    ...
                    <li>
                        {{
                            $t("There might be a typing error in the address.")
                        }}
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        <a href="#" class="go-back" @click="goBack()">{{
